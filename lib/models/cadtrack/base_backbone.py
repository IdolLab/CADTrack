...
from lib.models.cadtrack.utils import combine_tokens, recover_tokens
...
class BaseBackbone(nn.Module):
    ...
    def forward(self, z, x, track_query_before, **kwargs):
        """
        ...
        Returns:
            ...
            attn : None
        """
        x, aux_dict, len_zx = self.forward_features(z, x, track_query_before)
